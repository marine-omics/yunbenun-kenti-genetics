...
#		import pdb; pdb.set_trace()
	...
	REF=allele_maj #Need to ensure that this is coded as 0 in genotypes
	ALT=allele_min
	...
	# In the first line (ref) 1 indicates that we have the ref allele. Needs flipping because in vcf 0 indicates REF
	geno_1= [ flip_allele(g) for g in line1_values[samples_start_col:]]

	# In the second line (alt) 1 indicates that we have the alt. No need to flip because in vcf 1 indicates ALT
	...
	# Genotype: 0 is the reference and 1 is the alt
