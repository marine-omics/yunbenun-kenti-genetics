...
Picnic Bay and Geoffrey Bay. Nevertheless, neither C2 or C3 clusters is
specifically associated with a particular bay (both clusters are found
in PB and GB).
...
very subtle population structre in southern bays, possibly driven by
small population sizes or inbreeding is driving the PCA.
...
to correspond to biologically meaningful ancestral populations. Instead,
we suspect that subtle structure is being driven by differences in
genetic diversity between Northern and Southern bays. Our reasoning is
as follows;
