...
ak.chr.mi.adj.nosibs <- read_rds("ak.chr.mi.adj.nosibs.rds")

si <- subset_pop(ak.chr.mi.adj.nosibs,remove_id,focal_pop)
...
write_rds(si.ne,file = paste("jackknife_nosibs/",focal_pop,"_",iteration,".rds",collapse = "",sep = ""))
