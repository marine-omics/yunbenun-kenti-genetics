...
ak.chr.mi.adj.admix <- read_rds("ak.chr.mi.adj.admix.rds")

si <- subset_pop(ak.chr.mi.adj.admix,remove_id,focal_pop)
...
write_rds(si.ne,file = paste("jackknife_admix/",focal_pop,"_",iteration,".rds",collapse = "",sep = ""))
