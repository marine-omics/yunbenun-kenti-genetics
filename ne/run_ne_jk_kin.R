...
ak.chr.mi.adj.kin <- read_rds("ak.chr.mi.adj.kin.rds")

si <- subset_pop(ak.chr.mi.adj.kin,remove_id,focal_pop)
...
write_rds(si.ne,file = paste("jackknife_kin/",focal_pop,"_",iteration,".rds",collapse = "",sep = ""))
