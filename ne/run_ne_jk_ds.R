...
ak.chr.mi.adj.ds <- read_rds("ak.chr.mi.adj.ds.rds")

si <- subset_pop(ak.chr.mi.adj.ds,remove_id,focal_pop)
...
write_rds(si.ne,file = paste("jackknife_ds/",focal_pop,"_",iteration,".rds",collapse = "",sep = ""))
