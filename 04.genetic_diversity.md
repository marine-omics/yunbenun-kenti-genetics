...
```
    ...
    1  1  2  ADJ   MI 286 117     0  1344   285    22    15      1629 0.18   NA
      asym.sig
    1       NA
      Table of private alleles and fixed differences returned
    Completed: gl.report.pa 
...
```
    ...
    Starting gl.report.pa 
      Processing genlight object with SNP data
      p1 p2 pop1 pop2  N1 N2 fixed priv1 priv2 Chao1 Chao2 totalpriv   AFD asym
    1  1  2  ADJ   so 286 58     0  1402   217    22    14      1619 0.163   NA
    2  1  3  ADJ   no 286 59     2  1380   193    22     4      1573 0.164   NA
    3  2  3   so   no  58 59     0   278   276    14     4       554 0.028   NA
      asym.sig
    1       NA
    2       NA
    3       NA
