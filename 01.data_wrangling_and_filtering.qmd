...
The dataset analysed in the following script is from this publication: Erdmann et al., 2025. Population structure of Acropora kenti at inshore reefs of the Great Barrier Reef. Molecular Ecology.

This script analyses a SNP's dataset from DArT using the package darTRverse (version 2024), which contains 7 subpackages: https://github.com/green-striped-gecko/dartRverse
